    ...
    return (
        <ObjectTemplate {...props}>
            ...
            >
                ...
                <div className={[
                    'overflow-y-hidden duration-300',
                    more ? 'max-h-[400px]' : 'max-h-0',
                    ].join(' ')}
                >
...
const ColorPicker = ({
    ...
    return (
        <div className={[
            ...
            <button
                className={'flex w-full p-1 items-center justify-center border border-solid border-gray-400 rounded-md duration-500 hover:border-gray-700'}
