...
public class BoardIndexStep extends AbstractMybatisStep<Board, BoardIndex> {
    ...
    public void writer(
        ...
        Optional<String> saveMapperId = Optional.of("com.anamensis.server.mapper.BoardIndexMapper.save");
    ...
    public MyBatisCursorItemReader<Board> reader(Optional<String> findMapper, String ids) {
        Optional<String> findMapperId = Optional.of("com.anamensis.server.mapper.BoardMapper.findAllByIsUse");
