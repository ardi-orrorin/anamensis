DROP INDEX idx_id_desc_use ON board;
DROP INDEX idx_id_desc_use_title ON board;
DROP INDEX idx_id_desc_public_use ON board;
DROP INDEX idx_board_pk_use ON board_comment;
DROP INDEX idx_id_desc_member_pk ON point_history;
